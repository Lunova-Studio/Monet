...
namespace Monet.Shared.Media.Provider;

/// <summary>
/// Provides conversions needed for K-Means quantization. Converting input to points,
/// and converting the final state of the K-Means algorithm to colors.
/// </summary>
public sealed class PointProviderLab : IPointProvider {
    ...
    /// </summary>
    public double[] FromUInt(uint argb) {
        double[] lab = ColorUtil.LabFromArgb(argb);
