...
/// </summary>
public sealed class TonalSpotScheme : DynamicScheme {
    public TonalSpotScheme(Hct hct, bool isDark, double contrastLevel) : 
        base(hct, isDark, Enums.Variant.Tonal_Spot, contrastLevel,
