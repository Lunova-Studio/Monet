...
public sealed class ContentScheme(Hct hct, bool isDark, double contrastLevel) : DynamicScheme(
    hct,
    isDark,
    Variant.Content,
    contrastLevel,
    ...
    TonalPalette.CreateFromHct(ColorUtil.Fix(new TemperatureManager(hct).GetAnalogousColors(3, 6)[2])),
